...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, YnetFragment.OnFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmet(new YnetFragment());

        } else if (id == R.id.nav_gallery) {

            fragmet(new WallaFragment());


        } else if (id == R.id.nav_slideshow) {
            fragmet(new IsraelHayomFragmen());

        } else if (id == R.id.nav_manage) {

            fragmet(new OneFragment());
    ...
    //Create fragment
    private void fragmet(Fragment fragment ) {
